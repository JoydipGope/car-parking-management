  ...
  useEffect(() => {
    if (autoRefresh) {
      const interval = setInterval(() => {
        // In a real app, this would fetch updated data from API
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="monitoring" className="space-y-6">
                ...
                <Dialog open={isActivityDialogOpen} onOpenChange={setIsActivityDialogOpen}>
                  ...
                  <DialogContent className="max-w-2xl">
                    ...
                    <DialogFooter>
                      ...
                      <Button onClick={handleLogActivity} disabled={!selectedSlot || !activityForm.vehicleNumber.trim() || !activityForm.driverName.trim()}>
                        Log Activity
                      </Button>
                    </DialogFooter>
                  </DialogContent>
              ...
              <Dialog open={isMessageDialogOpen} onOpenChange={setIsMessageDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Communicate with parking space owners
                    </DialogDescription>
                  </DialogHeader>
              ...
              <Dialog open={isAlertDialogOpen} onOpenChange={setIsAlertDialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Report a security issue or violation
                    </DialogDescription>
                  </DialogHeader>
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="alert-slot">Select Slot</Label>
                  ...
                  <DialogFooter>
                    ...
                    <Button onClick={handleCreateAlert} disabled={!alertForm.slotId || !alertForm.description.trim()}>
                      Create Alert
                    </Button>
                  </DialogFooter>
                </DialogContent>
                        ...
                        {alert.status === 'resolved' && alert.resolution && (
                          <div className="bg-green-50 border border-green-200 rounded p-3 mb-4">
                            <p className="text-xs text-green-800 mb-1">
                              Resolved by {alert.resolvedBy} on {alert.resolvedAt ? new Date(alert.resolvedAt).toLocaleString() : 'Unknown'}
                            </p>
                      ...
                      <Card key={activity.id} className="mb-4">
                        <CardHeader className="pb-3">
                          <div className="flex items-center justify-between">
                            <CardTitle className="text-base flex items-center space-x-2">
                              ...
                              <span>{activity.vehicleNumber} - Slot {activity.slotNumber}</span>
                            </CardTitle>
                        ...
                        <CardContent>
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                              <p className="text-gray-500 mb-1">Expected Arrival</p>
                              <p>{new Date(activity.expectedArrival).toLocaleString()}</p>
                            </div>
                            <div>
                              <p className="text-gray-500 mb-1">Expected Departure</p>
                              <p>{new Date(activity.expectedDeparture).toLocaleString()}</p>
                            </div>
                            {activity.actualArrival && (
                              <div>
                                <p className="text-gray-500 mb-1">Actual Arrival</p>
                                <p className="text-green-600">{new Date(activity.actualArrival).toLocaleString()}</p>
                              </div>
                            )}
                            {activity.actualDeparture && (
                              <div>
                                <p className="text-gray-500 mb-1">Actual Departure</p>
                                <p className="text-gray-600">{new Date(activity.actualDeparture).toLocaleString()}</p>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="flex justify-between items-center mt-4 text-xs text-gray-500">
                            <span>Logged by: {activity.loggedBy}</span>
                            <span>{new Date(activity.loggedAt).toLocaleString()}</span>
                          </div>
                        </CardContent>
                      </Card>
                    ))
          ...
          <TabsContent value="reports" className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-lg">Security Reports & Analytics</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <CardContent>
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{vehicleActivities.filter(act => act.status === 'arrived' && new Date(act.loggedAt).toDateString() === new Date().toDateString()).length}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Vehicle Departures</span>
                      <span>{vehicleActivities.filter(act => act.status === 'departed' && new Date(act.loggedAt).toDateString() === new Date().toDateString()).length}</span>
                    </div>
                    <div className="flex justify-between">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span>Avg Alert Response</span>
                      <span>12 min</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Avg Message Response</span>
                      <span>5 min</span>
                    </div>
                    <div className="flex justify-between">
      ...
      <Dialog open={isResolveAlertDialogOpen} onOpenChange={setIsResolveAlertDialogOpen}>
        <DialogContent>
          ...
          {selectedAlert && (
            <div className="space-y-4">
              <div className="bg-gray-50 p-3 rounded">
                ...
                <p className="text-sm">
                  <strong>Slot:</strong> {selectedAlert.slotNumber} • 
          ...
          <DialogFooter>
            ...
            <Button onClick={handleResolveAlert} disabled={!resolutionForm.resolution}>
              Resolve Alert
            </Button>
          </DialogFooter>
        </DialogContent>
